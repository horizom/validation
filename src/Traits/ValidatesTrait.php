...
trait ValidatesTrait
{
    ...
    {
        return isset($value) && !self::isEmpty($value);
    }
     ...
     *
     * @return bool
     * @throws ValidationException if Twitter API has changed, in such case report on GitHub please.
     */
    protected function validate_valid_twitter($field, array $input, array $params = [], $value = null)
    {
        ...
        if (!isset($result->reason)) {
            throw new ValidationException('Twitter JSON response changed. Please report this on GitHub.');
        }
